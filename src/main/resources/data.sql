...
INSERT INTO USER  (id, email, name, roles, password) VALUES (1, 'marco@libero.it', 'Marco', 'USER', 'user');
INSERT INTO USER  (id, email, name, roles, password) VALUES (2, 'antonio@libero.it', 'Antonio', 'ADMIN', 'admin');
